    ...
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-y-0 h-full  w-full" aria-hidden="true">
        <div className="relative h-full">
          <BackgroundPattern classNames="absolute text-orange-600 opacity-25 top-[318px] left-[-302px] w-[864px] h-[1084px]" />

          <BackgroundPattern classNames="absolute text-orange-600 opacity-25 top-[535px] right-[-221px] w-[864px]" />
        </div>
      </div>
      ...
      <div className="relative pt-6 pb-16 sm:pb-24">
        ...
        <div className="mx-auto mt-16 max-w-7xl px-4 sm:mt-24 sm:px-6">
          <div className="text-center">
            <h2 className="text-lg font-semibold  opacity-75 ">
              It&apos;s not hording if you remember it
            </h2>
            <h1 className="mt-1 text-4xl font-black tracking-tight  sm:text-5xl md:text-6xl">
              <span className="block">Collect knowledge</span>
              <span className="block text-[#E57E83]">remember you backlog</span>
            </h1>
